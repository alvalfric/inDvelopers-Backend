...
class PayPalControllerUnitTests {
	...
	void testPayment() throws Exception {
		...
		when(service.createPayment(any(Double.class), any(String.class), any(String.class), any(String.class), any(String.class), any(String.class), any(String.class), any(String.class))).thenReturn(payment);

		mvc.perform(post("/payments/pay").contentType(MediaType.APPLICATION_JSON).content(bodyContent)).andExpect(status().isOk());
	...
	void testBuy() throws Exception {
		...
		payment.setState("approved");
		payment.setLinks(new ArrayList<Links>());
		when(service.createPaymentToUs(any(Double.class), any(String.class), any(String.class), any(String.class), any(String.class), any(String.class), any(String.class))).thenReturn(payment);
		when(orderService.save(any(Order.class))).thenReturn(order);
