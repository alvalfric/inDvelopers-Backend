...
public class GameControllerTests {
	...
	void testAddGame() throws Exception {
		Game res = new Game("GameRes", "DescriptionRes", "RequirementsRes", 0.0, "idCloudRes", true, developer1, null, null, null, 18);
	...
	void testAddGameNotFree() throws Exception {
		Game res = new Game("GameRes", "DescriptionRes", "RequirementsRes", 10.0, "idCloudRes", true, null, null, null, null, 18);
		String bodyContent = objectToJsonStringContent(res);
