...
public class GameControllerTests {
	...
	@BeforeEach
	void setUp() {
		developer1 = new Developer("developer1", "developer1", "developer1@gmail.com", null, new HashSet<UserRole>(),
				null, null, false, null, new ArrayList<Developer>());

		developer1.setId("dev1Id");

		developer2 = new Developer("developer2", "developer2", "developer2Developer@gmail.com", null,
				new HashSet<UserRole>(), null, null, true, null, new ArrayList<Developer>());
		...
		game2 = new Game("Game2", "description2", "requirements2", 10.0, "idCloud2", false, developer2,
				"",
				null, null, 18, 0., null, null);
	...
	void testAddGame() throws Exception {
		...
		mvc.perform(post("/games/add").contentType(MediaType.APPLICATION_JSON).content(bodyContent))
				.andExpect(status().isCreated()).andExpect(content().string("Added Game"));
	}
	...
	void testAddGameNotFree() throws Exception {
		Game res = new Game("GameRes", "DescriptionRes", "RequirementsRes", 10.0, "idCloudRes", true, null, null, null,
				null, 18, 0., null, null);
		String bodyContent = objectToJsonStringContent(res);
	...
	void testUpdateGame() throws Exception {
		...
		mvc.perform(put("/games/edit/ID").contentType(MediaType.APPLICATION_JSON).content(bodyContent))
				.andExpect(status().isOk()).andExpect(content().string("Edited Game"));
	}
	...
	void testFindGameByTitle() throws Exception {
		...
		mvc.perform(get("/games/findByTitle/Game1")).andExpect(status().isOk())
	...
	void testFindGameByDeveloper() throws Exception {
		...
		mvc.perform(get("/games/findByDeveloper/developer1")).andExpect(status().isOk())
				.andExpect(jsonPath("$[0].id").value("game1Id"));
	}
	...
	void testFindGameByTopSellers() throws Exception {
		...
		mvc.perform(get("/games/findByTopSellers")).andExpect(status().isOk())
				.andExpect(jsonPath("$[0].id").value("game1Id"));
	}
	...
	void testFindVerifiedGames() throws Exception {
		...
		mvc.perform(get("/games/findVerified")).andExpect(status().isOk())
				.andExpect(jsonPath("$[0].id").value("game1Id"));
	}
	...
	void testFindNotRevisedGames() throws Exception {
		...
		mvc.perform(get("/games/findNotRevised")).andExpect(status().isOk())
				.andExpect(jsonPath("$[0].id").value("game2Id"));
	}
	...
	void testFindByTitleVerifiedGames() throws Exception {
		...
		mvc.perform(get("/games/findByTitleVerified/" + game1.getTitle())).andExpect(status().isOk())
				.andExpect(jsonPath("$[0].id").value("game1Id"));
	}
