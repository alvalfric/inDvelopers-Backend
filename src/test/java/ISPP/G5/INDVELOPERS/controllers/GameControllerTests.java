...
public class GameControllerTests {
	...
	void setUp() {
		developer1 = new Developer("developer1", "developer1", "developer1@gmail.com", null,
				new HashSet<UserRole>(), null, null, false, null, new ArrayList<Developer>());
	...
	void testAddGame() throws Exception {
		Game res = new Game("GameRes", "DescriptionRes", "RequirementsRes", 0.0, "idCloudRes", true, developer1, null, null, null, 18,0.);
	...
	void testAddGameNotFree() throws Exception {
		Game res = new Game("GameRes", "DescriptionRes", "RequirementsRes", 10.0, "idCloudRes", true, null, null, null, null, 18,0.);
		String bodyContent = objectToJsonStringContent(res);
