...
public class ReviewControllerUnitTests {
	...
	@BeforeEach
	void setUp() {
		developer = new Developer("hola", "adios", "email", null, new HashSet<UserRole>(),
				"description", "none", true, null, new ArrayList<Developer>());
		...
		game.setId("gameID");
		r1 = new Review("Text1", 1., false, game, developer);
		r1.setId("rev1ID");
		r2 = new Review("Text2", 2., false, game, developer);
		r2.setId("rev2ID");
	}
	...
	void createReviewForAGame() throws Exception {
		...
		mvc.perform(post("/reviews/game/ID/add").contentType(MediaType.APPLICATION_JSON).content(bodyContent))
				.andExpect(status().isOk()).andExpect(content().string("Added Review"));
	}
	...
	void deleteReview() throws Exception {
		...
		mvc.perform(delete("/reviews/delete/ID")).andExpect(status().isOk())
				.andExpect(content().string("Deleted Review"));
	}
