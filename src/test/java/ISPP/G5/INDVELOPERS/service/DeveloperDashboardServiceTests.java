...
@SpringBootTest
public class DeveloperDashboardServiceTests {
	...
	void initAll() throws NotFoundException {
		...
		Publication publication = new Publication("martaad", imagenB64, "description of publication", imagenB64,
				developer1);
	...
	@Test
	@DisplayName("Show developer dashboard")
	@WithMockUser(username = "developer1", authorities = { "USER" })
	void shouldShowDashboard() throws NotFoundException {
		DeveloperDashboard res = this.developerDashboardService.show();
		assertThat(res).isNotNull();
		assertTrue(res.getNumGamesCreated() == 1);
	}

	@Test
	@DisplayName("Find game by developer")
	void shouldFindGameByDeveloper() throws NotFoundException {
		List<Game> res = this.developerDashboardService.findGameByDeveloper(developer1.getId());
		assertThat(res).isNotNull();
		assertThat(res).contains(game1);
		assertFalse(res.contains(game2));
	}

	@Test
	@DisplayName("Find publication by username")
	void shouldFindPublicationByUsername() throws NotFoundException {
		List<Publication> res = this.developerDashboardService.findPublicationByUSername("martaad");
		assertThat(res).isNotNull();
		assertThat(res).contains(publication1);
	}

	@Test
	@DisplayName("Find review by developer")
	void shouldFindReviewByDeveloper() throws NotFoundException {
		List<Review> res = this.developerDashboardService.findReviewByDeveloper(developer2.getId());
		assertThat(res).isNotNull();
		assertThat(res).contains(review1);
	}

	@Test
	@DisplayName("Find games by my games test")
	void shouldFindGameByMyGames() {
		assertThat(this.developerDashboardService.findGameByMyGames(developer1.getId())).contains(game1);
	}

	@Test
	@DisplayName("Find games by my owned games test")
	void shouldFindGameByOwnedGames() {
		assertTrue(this.developerDashboardService.findOwnedGames(developer1) == 1);
	}

	@Test
	@DisplayName("Show money earned test")
	void shouldFindMoneyEarned() {
		assertTrue(this.developerDashboardService.moneyEarned(developer2) == 10.0);
	}
}
